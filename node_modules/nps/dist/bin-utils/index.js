...
exports.loadConfig = exports.preloadModule = exports.getModuleRequirePath = exports.help = exports.initialize = undefined;
...
function loadConfig(configPath, input) {
  ...
  if ((0, _lodash.isFunction)(config)) {
    ...
    typeMessage = `Your config data type was "${(0, _typeDetect2.default)(config)}"`;
  }
...
function help(_ref) {
  ...
  var scriptLines = filteredScripts.map(function (_ref2) {
    ...
    var line = void 0;
    if (description) {
      line = [coloredName, _chalk2.default.white(description), coloredScript];
    } else {
